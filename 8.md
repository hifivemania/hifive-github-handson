...
```
```
<textarea id="comment" name="comment"  class="form-control" data-required data-size="[10,200]" /></textarea>
```
...
ここまでのコードは[hifive-handson/8 at master · moongift/hifive-handson](https://github.com/moongift/hifive-handson/tree/master/8)にて確認できます。また、[実際に動いているデモはこちらのURL](https://moongift.github.io/hifive-handson/8/)にて確認できます。
