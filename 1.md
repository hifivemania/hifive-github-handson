...
ここまでの内容は[こちらのURLで実際に動いているものが確認できます](https://moongift.github.io/hifive-handson/1/)。また、[hello.jsを含むコードはこちらで確認できます](https://github.com/moongift/hifive-handson/tree/master/1)。
