...
まずベースになる[HTML/JavaScriptファイル（Zipで固めてあります）をダウンロード](https://github.com/moongift/hifive-handson/raw/master/1.zip)します。ダウンロードしたらZipファイルを解凍してください。
...
hello.jsを含む今回のコードは[hifive-handson/4 at master · moongift/hifive-handson](https://github.com/moongift/hifive-handson/tree/master/1)にて確認できます。また、[実際に動いているデモはこちらのURL](https://moongift.github.io/hifive-handson/1/)にて確認できます。
