...
```
$ git commit -a -m "Validate"
```

そしてGitHubへプッシュします。

```
$ git push origin validate
```
...
今回のコードは[hifive-github-handson/6 at master · hifivemania/hifive-github-handson](https://github.com/hifivemania/hifive-github-handson/tree/master/6)にて確認できます。また、[実際に動いているデモはこちらのURL](https://hifivemania.github.io/hifive-github-handson/6/)にて確認できます。

では次は[日報アプリを作る（その5）「画像のサムネイルを表示する」](7.md)で画像を選択した時にサムネイルを表示する処理を作ってみましょう。
